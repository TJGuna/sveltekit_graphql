                ...
                {#each items as item}
                        <ul role="list" class="-mx-2 ">
                            <li>
                                ...
                                <a href="{item.link}" class="bg-indigo-700 text-white group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
                                    <img src={item.icon}>
                                    {item.title}
                                </a>
                            </li>
        ...
        <div class="sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-4 border-b border-gray-200 bg-white px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
                ...
                <div class="flex items-center gap-x-4 lg:gap-x-6">
                    ...
                    <!-- Profile dropdown -->
                    <div class="relative">
                        <button on:click={()=>isProfileMenuOpen = !isProfileMenuOpen} type="button" class="-m-1.5 flex items-center p-1.5" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
